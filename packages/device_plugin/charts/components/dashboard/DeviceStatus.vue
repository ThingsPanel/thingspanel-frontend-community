...
<template>
  <div class="device-status-container" @click="showDialog(null)">
    ...
    <el-dialog class="dark-dialog" title="绑定图表" width="500px" :visible.sync="dialogVisible" :append-to-body="true" :close-on-click-modal="false">
  ...
  data() {
    return {
      ...
      formRule: {
        ...
        thresholdTime: [{required: true, message: "请输入离线时间阈值"}]
      },
      fontSize: 30,   // 标题文字大小
      title: "",   // 标题
