/**
 * Visual Editor 相对路径修复脚本
 * 将 src/components/visual-editor 目录中所有相对路径统一转换为 @/ 绝对路径
 */
const fs = require('fs');
const path = require('path');

// visual-editor 目录的路径
const VISUAL_EDITOR_DIR = './src/components/visual-editor';
 ...
 */
function main() {
  console.log('🚀 开始处理 Visual Editor 目录的相对路径转换...\n');
  
  // 获取所有文件
  const files = getAllFiles(VISUAL_EDITOR_DIR);
  ...
  console.log('\n' + '='.repeat(60));
  console.log(`✨ Visual Editor 相对路径转换完成!`);
  console.log(`📊 统计结果:`);
