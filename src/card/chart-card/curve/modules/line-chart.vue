...
const timeMap = {
  last_15m: $t('card.general.last15Minutes'),
  last_30m: $t('card.general.last30Minutes'),
  last_1h: $t('card.general.last1Hour'),
  last_3h: $t('card.general.last3Hours'),
  last_6h: $t('card.general.last6Hours'),
  last_12h: $t('card.general.last12Hours'),
  last_24h: $t('card.general.last24Hours'),
  last_3d: $t('card.general.last3Days'),
  last_7d: $t('card.general.last7Days'),
  last_15d: $t('card.general.last15Days'),
  last_30d: $t('card.general.last30Days'),
  last_60d: $t('card.general.last60Days'),
  last_90d: $t('card.general.last90Days'),
  today: $t('card.general.today'),
  yesterday: $t('card.general.yesterday'),
  dayBeforeYesterday: $t('card.general.dayBeforeYesterday'),
  lastWeek: $t('card.general.lastWeek'),
  thisWeek: $t('card.general.thisWeek'),
  thisMonth: $t('card.general.thisMonth'),
  lastMonth: $t('card.general.lastMonth')
}
...
const getTelemetryData = async (device_id, key, index, metricName) => {
  const sampleObj = {
    ...
    itemStyle: {
      ...
      ]) // {{ $t('card.general.custom') }}card.general.颜色
    },
    areaStyle: {
      opacity: 0.8,
      color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
