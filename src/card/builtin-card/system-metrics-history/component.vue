...
const processData = (apiData: any): { timeAxis: string[], timestamps: number[], cpuData: number[], memData: number[], diskData: number[] } => {
...
const updateChartOption = (processedData: { timeAxis: string[], timestamps: number[], cpuData: number[], memData: number[], diskData: number[] }) => {
  ...
  const areaColors = [
    { type: 'linear', x: 0, y: 0, x2: 0, y2: 1, colorStops: [{ offset: 0, color: 'rgba(84, 112, 198, 0.3)' }, { offset: 1, color: 'rgba(84, 112, 198, 0)' }] },
    { type: 'linear', x: 0, y: 0, x2: 0, y2: 1, colorStops: [{ offset: 0, color: 'rgba(145, 204, 117, 0.3)' }, { offset: 1, color: 'rgba(145, 204, 117, 0)' }] },
    { type: 'linear', x: 0, y: 0, x2: 0, y2: 1, colorStops: [{ offset: 0, color: 'rgba(250, 200, 88, 0.3)' }, { offset: 1, color: 'rgba(250, 200, 88, 0)' }] }
  ];
  ...
  chartOption.value = {
    ...
    tooltip: {
      ...
      formatter: (params: any) => { // Keep the formatter
