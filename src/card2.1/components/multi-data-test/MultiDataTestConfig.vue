  ...
  <div class="multi-data-test-config">
    <n-form label-placement="left" label-width="80px" size="small">
      <n-form-item label="标题">
        <n-input v-model:value="config.title" placeholder="显示标题" @update:value="updateConfig" />
      </n-form-item>

      <n-form-item label="颜色">
        <n-input v-model:value="config.color" placeholder="显示颜色" @update:value="updateConfig" />
      </n-form-item>
