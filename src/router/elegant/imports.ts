...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "test_basic-test": () => import("@/views/test/basic-test/index.vue"),
  "test_card2-components-test": () => import("@/views/test/card2-components-test/index.vue"),
  "test_data-flow-test": () => import("@/views/test/data-flow-test/index.vue"),
  "test_data-source-config": () => import("@/views/test/data-source-config/index.vue"),
  "test_data-update-fix-test": () => import("@/views/test/data-update-fix-test/index.vue"),
  "test_datasource-integration": () => import("@/views/test/datasource-integration/index.vue"),
  "test_datasource-processor-test": () => import("@/views/test/datasource-processor-test/index.vue"),
  ...
  "test_simple-data-source": () => import("@/views/test/simple-data-source/index.vue"),
  ...
  "visualization_visual-editor-details": () => import("@/views/visualization/visual-editor-details/index.vue"),
};
