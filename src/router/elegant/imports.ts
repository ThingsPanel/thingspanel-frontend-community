...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  paneldemo: () => import('@/views/paneldemo/index.vue'),
  ...
  'test-draggable-grid_index': () => import('@/views/test-draggable-grid/index.vue'),
  'test-draggable-grid_optimized': () => import('@/views/test-draggable-grid/optimized.vue'),
  ...
  'visualization_visual-editor-demo': () => import('@/views/visualization/visual-editor-demo/index.vue'),
