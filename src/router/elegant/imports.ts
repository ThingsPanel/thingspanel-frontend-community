...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  test_unifiedarchitecturetest: () => import("@/views/test/UnifiedArchitectureTest/index.vue"),
  "test_card2-config-test": () => import("@/views/test/card2-config-test/index.vue"),
  ...
  "test_data-source-config-form-test": () => import("@/views/test/data-source-config-form-test/index.vue"),
  "test_data-source-system-test": () => import("@/views/test/data-source-system-test/index.vue"),
