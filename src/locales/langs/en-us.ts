...
const local: App.I18n.Schema = {
  ...
  common: {
    ...
    addExtendedInfo: 'Create Extended Information',
  ...
  route: {
    ...
    'automation_scene-linkage': 'Scene Automations',
    'automation_linkage-edit': 'Edit Automation',
    automation: 'Automations',
    alarm: 'Alarm',
    'alarm_notification-group': 'Alarm Groups',
    ...
    device_service_access: 'Device Service Integration',
    ...
    'alarm_warning-message': 'Alarm Center',
    'personal-center': 'Personal Center',
    apply_plugin: 'Apply Plugin',
    'device_service-access': 'Device Service Integration',
  ...
  page: {
    ...
    dataForward: {
      ...
      hostIP: 'Host/IP:',
      enterHostIP: 'Please enter host or IP',
      port: 'Port:',
  ...
  device_template: {
    ...
    table_header: {
      ...
      PleaseEventDescription: 'Please Event Description',
      singleControlTaskl: 'Single Control Task',
      PleaseEventName: 'Please Event Name',
      PleaseEeventIdentifier: 'Please Event Identifier',
      setEnum: 'Set Enum',
      addEnum: 'Create Enum',
  ...
  custom: {
    ...
    devicePage: {
      ...
      unlimitedDeviceConfig: 'Any Device Configuration',
      ...
      alarm: 'Alarm',
      noAlarm: 'No Alarm',
      unlimitedAccessType: 'Any Access Type',
    ...
    grouping_details: {
      ...
      device: 'Device',
      addDeviceToGroup: 'Create Device to Group',
      detail: 'Detail',
      setting: 'Setting',
      edit: 'Edit',
  ...
  generate: {
    ...
    btnname: 'Button Name',
    sceneLinkageName: 'Associated scene automation name',
    ...
    sceneLinkDesc: 'Please enter a scene automation description',
    ...
    'max-value': 'Max Value',
    'min-value': 'Min Value',
    inputMaxValue: 'Please enter the maximum value',
    inputMinValue: 'Please enter a minimum value',
    sum: 'sum',
    diff: 'diff',
    ...
    'save-scene-linkage': 'Save Scene Automation',
    button: 'Button',
    then: 'then:',
    ...
    'enter-scene-linkage-name': 'Enter scene automation name',
    ...
    'add-data-processing': 'Create Data Processing',
    'enter-large-screen-name': 'Please Enter Screens Name',
    ...
    'add-extension-info': 'Create Extension Info',
    'rule-engine': 'Rule Engine',
    ...
    '+add-scene-linkage': '+Create Scene Automation',
    ...
    'notification-record': 'Alarm History',
    ...
    fieldValue: 'Value',
    fieldKey: 'Key',
    addAlarm: 'Create Alarm',
    addAlarmRule: 'Create Alarm Rule',
  ...
  card: {
    ...
    selectCard: 'Please select adding card',
    selectDataTimeFrame: 'Please select data time frame',
    selectDataAggregationRange: 'Please select the data aggregation scope',
    selectIndicator: 'Please select an indicator',
    selectDataAggregationMethod: 'Please select data aggregation method',
    ...
    directConnectDevice: 'Directly connected devices',
    gatewayDevice: 'Gateway Device',
    ...
    fillDeviceAccessAddress: 'Please fill in with the device access address',
    enterServiceName: 'Please enter a service name',
    enterServiceIdentifier: 'Please enter a service identifier',
    selectServiceType: 'Please select service type',
    serviceName: 'Service name',
    serviceIdentifier: 'Service identifier',
    type: 'Type',
    version: 'Version',
    enterVersion: 'Please enter the service version',
    description: 'Description',
    enterDescription: 'Please enter description',
