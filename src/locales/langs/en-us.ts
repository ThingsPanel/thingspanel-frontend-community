...
const local: App.I18n.Schema = {
  ...
  common: {
    ...
    enterAlarmDesc: 'Enter the alarm description',
    alarmRules: 'Alarm Rules',
    alarmHistory: 'Alarm History',
    sceneLinkageInfo: 'Confirm whether to delete the scene automation information?',
    ...
    enterAlarmLevel: 'Enter the alarm level',
    enterAlarmName: 'Enter the alarm name',
    ...
    deleteDeviceConfig: 'Confirm whether to delete the device configuration?',
    ...
    deleteProcessing: 'Confirm whether to delete the data processing?',
    ...
    activateSceneInfo: 'Confirm whether to activate the scene information?',
    activationPrompt: 'Activation Prompt',
    deleteSceneInfo: 'Confirm whether to delete the scene information?',
    deletePrompt: 'Delete Prompt',
    addArea: 'Create Area',
    addSpace: 'Create Space',
    sending: 'Sending',
    base: 'Base',
    saveSceneInfo: 'Confirm whether to save the scene information?',
    ...
    pleaseCheckValue: 'Check whether the value is valid',
    refresh: 'Refresh',
    reset: 'Reset',
    search: 'Search',
    tip: 'Tip',
