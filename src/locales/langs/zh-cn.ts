...
const local: App.I18n.Schema = {
  ...
  device_template: {
    ...
    stepThreeDescribe: '设置设备是否导入并绑定设备设备模板',
    ...
    editAppDetailsPage: '编辑该设备设备模型的App详情页',
    release: '发布',
  ...
  generate: {
    ...
    'more-dynamics': '更多动态',
    issue: '下发',
    'select-device-function-template': '选择设备设备模型',
    ...
    'extension-info': '扩展信息',
    'next-step': '下一步',
    'add-device-function-template': '添加设备设备模型',
    'email-address': '电子邮箱',
    demo: '插件demo地址：',
    ...
    'enter-key': '请输入key',
    close: '关闭：',
    'bind-device-function-template': '绑定设备设备模型',
    open: '开启：',
    copy: '复制',
    'basic-info': '基本信息',
