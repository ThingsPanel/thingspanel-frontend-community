<template>
  <n-form size="small" label-placement="left" label-width="70">
    ...
    <n-form-item label="显示图例">
      <n-switch 
        :value="properties.showLegend"
        @update:value="updateProperty('showLegend', $event)"
      />
    </n-form-item>
    <n-form-item label="显示网格">
      <n-switch 
        :value="properties.showGrid"
        @update:value="updateProperty('showGrid', $event)"
      />
    </n-form-item>
  </n-form>
</template>
