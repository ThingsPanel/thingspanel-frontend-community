...
| [Card 2.1 集成文档](./CARD2_INTEGRATION.md) | Card 2.1 组件集成说明 | ✅ 完整 |
| [架构设计备份](./architecture-design-backup.md) | 历史架构设计文档 | 📝 备份 |
| [目录结构备份](./directory-structure-backup.md) | 项目结构说明 | 📝 备份 |
...
| 文档 | 描述 | 状态 |
|------|------|------|
| [组件注册文档](./WIDGET_REGISTRATION.md) | 组件注册相关说明 | ✅ 完整 |
...
| [交互增强文档](./README-enhanced-interaction.md) | 交互功能增强说明 | ✅ 完整 |
| [MVP 计划](./minimal-mvp-plan.md) | 最小可行产品计划 | 📝 计划 |
...
- [交互增强文档](./README-enhanced-interaction.md)
