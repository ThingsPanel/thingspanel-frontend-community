          ...
          <n-tooltip>
            <template #trigger>
              <n-icon size="14" style="color: var(--text-color-3); cursor: help;">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="m9,9a3,3 0 1,1 6,0c0,2 -3,3 -3,3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="m12,17.02v.01" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </n-icon>
            </template>
            <div style="max-width: 250px; font-size: 12px;">
              ...
              <div style="margin-top: 4px;">
                • <code>$</code> 或 空白：使用完整数据<br/>
                • <code>$.data</code>：提取 data 字段<br/>
                • <code>$.data.list</code>：提取 data.list 数组<br/>
                • <code>$.users[0]</code>：提取 users 数组第一项<br/>
                • <code>$.result.items</code>：提取嵌套对象
              </div>
            </div>
          </n-tooltip>
        </n-space>
