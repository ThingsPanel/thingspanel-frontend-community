...
/**
 * Returns the first item this layout collides with. It doesn't appear to matter which order we approach this from,
 * although perhaps that is the wrong thing to do.
 *
 * @param {Object} layoutItem Layout item.
 * @returns {Object | undefined} A colliding layout item, or undefined.
 */
// eslint-disable-next-line consistent-return
 ...
 * @param isUserAction If true, designates that the item we're moving is being dragged/resized by th euser.
 */
// eslint-disable-next-line max-params
...
/**
 * This is where the magic needs to happen - given a collision, move an element away from the collision. We attempt to
 * move it up if there's room, otherwise it goes below.
 *
 * @param layout Full layout to modify.
 ...
 *
 * @returns Layout, sorted static items first.
 */
