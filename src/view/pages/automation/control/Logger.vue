 ...
 * @LastEditTime: 2023-02-17 11:07:11
 * @FilePath: \ThingsPanel-Backend-Vue\src\view\pages\automation\control\Logger.vue
 * @Description: 控制策略日志
-->
<template>
  <el-dialog title="日志" class="el-dark-dialog" :close-on-click-modal="false" :visible.sync="dialogVisible"
    ...
    <el-table :data="tableData" v-loading="loading">
        ...
        <el-table-column label="处理说明" prop="process_description"></el-table-column>
  
        <el-table-column label="处理结果" prop="process_result">
