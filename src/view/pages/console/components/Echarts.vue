<template>
  <div class="chart-div" :style="getChartStyle()" >
    ...
    <div class="echarts" style="width: 100%; height:100%;position: absolute;top:0px;padding:6px" ref="chart" id="echarts" @click="handleClick"></div>
...
export default {
  ...
  methods: {
     ...
     */
    updateOption(value) {
      console.log("updateOption.echarts", value);
