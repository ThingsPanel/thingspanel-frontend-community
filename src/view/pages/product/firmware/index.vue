    ...
    <div class="rounded card p-4 el-table-transparent el-dark-input">
        <el-row type="flex" :gutter="20" class="pt-3 pb-4 px-3">
            ...
            <el-col :span="12" class="px-2 text-right">
                <el-button size="medium" type="border" @click="handleCreate">{{ $t('PRODUCT_MANAGEMENT.FIRMWARE_LIST.ADDFIRMWARE') }}</el-button>
              </el-col>
        </el-row>
        <el-row type="flex" :gutter="20" class="pt-3 pb-4 px-3">
            <el-col :span="4">
                <el-select v-model="params.product_id" :placeholder="$t('COMMON.PLACEHOLDER5')">
                    <el-option :label="$t('PRODUCT_MANAGEMENT.FIRMWARE_LIST.ALL_PRODUCTS')" value="all" key="all"></el-option>
                    <!-- 遍历产品列表 -->
            ...
            <el-col :span="4">
                <!-- 给el-input添加tooltip -->
                <el-tooltip effect="dark" :content="$t('PRODUCT_MANAGEMENT.FIRMWARE_LIST.PLACEHOLDER1')" placement="top">
                    <el-input :placeholder="$t('PRODUCT_MANAGEMENT.FIRMWARE_LIST.PLACEHOLDER1')" v-model="params.package_name"></el-input>
                </el-tooltip>
        ...
        <el-form class="inline-edit">
            <el-table :data="tableData" v-loading="loading">
                ...
                <!-- 升级包名称-->
                <el-table-column :label="$t('PRODUCT_MANAGEMENT.FIRMWARE_LIST.FIRMWARE_LIST_ADD.PACKAGE_NAME')" prop="package_name" align="left"/>

                <!-- 升级包版本号-->
                <el-table-column :label="$t('PRODUCT_MANAGEMENT.FIRMWARE_LIST.FIRMWARE_LIST_ADD.PACKAGE_VERSION')" prop="package_version" align="center"/>

                <!-- 归属产品-->
                <el-table-column :label="$t('PRODUCT_MANAGEMENT.FIRMWARE_LIST.FIRMWARE_LIST_ADD.BELONGINGPRODUCT')" prop="product_name" align="center">
                </el-table-column>

                <!-- 模块名称-->
                <el-table-column :label="$t('PRODUCT_MANAGEMENT.FIRMWARE_LIST.FIRMWARE_LIST_ADD.PACKAGE_NAME')" prop="package_module" align="center">
                </el-table-column>

                <!-- 描述-->
                <el-table-column :label="$t('PRODUCT_MANAGEMENT.FIRMWARE_LIST.FIRMWARE_LIST_ADD.DESCRIPTION')" prop="description" align="center">
                </el-table-column>
