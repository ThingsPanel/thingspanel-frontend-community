  ...
  <el-table :data="tableData" v-loading="loading">
    ...
    <el-table-column prop="actions" :label="$t('RULE_ENGINE.DATA_FORWARDING.OPERATION')" align="left" width="320px">
      <template v-slot="scope">
        ...
        <el-popconfirm :confirm-button-text="$t('COMMON.CONFIRM')" :cancel-button-text="$t('COMMON.CANCEL')" :title="$t('RULE_ENGINE.DATA_FORWARDING.TITLE4')" @confirm="handle_del(scope.row)">
