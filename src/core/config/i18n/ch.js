...
export const locale = {
  ...
  */
  ...
  LOGIN: {
    ...
    GET_SMS_CODE: "获取验证码",
    RESEND_TEXT: "秒后重新发送",
    SIGN_IN_WITH_EXIST_ACCOUNT: "已有账号？立即登录",
    RESET_NOW: "立即重置",
    PASSWORD_RESET: "密码重置",
    SIGN_UP: "注册",
  },
   ...
   */
    ...
    DEVICE_CONFIG: {
      ...
      CONFIRM: "确定",
      OVERVIEW: "概览",
      PROPERTIES_REPORT: "属性(上报)",
      EVENT_REPORT: "事件(上报)",
      COMMAND_DELIVERY:"命令(下发)",
      DEVICE_PLUGIN:"设备插件",
      DEVICE_LOG:"设备日志",
      CURRENT_PROPERTIES: "当前属性",
      OTHER_PROPERTIES: "其他属性",
      DEVICE_ID: "设备ID",
      FIRMWARE_VERSION: "固件版本",
      CHECK_HISTORY_DATA: "查看历史数据",
      CHECK_TIMING_CHART: "查看时序图表",
      ATTRIBUTE_HISTORY_DATA: "属性历史数据",
      TIMESTAMP: "时间",
      ATTRIBUTE: "属性",
      VALUE: "值",
      ATTRIBUTE_TYPE: "属性类型",
      RANGE:{
        ...
        SIX_MONTHS: "半年",
        ONE_YEAR: "1年",
        LAST_THIRTY_SECONDS: "最近30秒",
        LAST_ONE_MINUTE: "最近1分钟",
        LAST_TWO_MINUTES: "最近2分钟",
        LAST_FIVE_MINUTES: "最近5分钟",
        LAST_TEN_MINUTES: "最近10分钟",
        LAST_FIFTEEN_MINUTES: "最近15分钟",
        LAST_THIRTY_MINUTES: "最近30分钟",
        LAST_ONE_HOUR: "最近1小时",
        LAST_THREE_HOURS: "最近3小时",
        LAST_SIX_HOURS: "最近6小时",
        LAST_ONE_DAY: "最近1天",
        LAST_THREE_DAYS: "最近3天",
        LAST_SEVEN_DAYS: "最近7天",
        LAST_ONE_MONTH: "最近1个月",
        LAST_SIX_MONTHS: "最近半年",
        LAST_ONE_YEAR: "最近1年",
        AVERAGE: "平均值",
        MAX: "最大值",
        MIN: "最小值",
      ...
      ATTRIBUTE: {
        DELIVERY_ATTRIBUTE: "下发属性",
        ATTRIBUTE_NAME: "属性名称",
        ATTRIBUTE_IDENTIFIER: "属性标识符",
        ATTRIBUTE_VALUE: "属性值",
        UPDATE_TIME: "更新时间",
        HISTORY_DATA: "历史数据",
        CHART_ANALYSIS: "图表分析",
  ...
  VISUALIZATION: {
    ...
    CONSOLE: {
      ...
      CREATE_BLANK_CONSOLE: "创建空白看板",
      PLEASE_INPUT_TEMPLATE_ID: "请输入模板编号",
      SHARE_COSNOLE: "分享看板",
      SHARE_LINK: "分享链接",
      WHO_CAN_ACCESS: "谁可以访问",
      ONLY_ME: "仅自己可见",
      EVERYONE: "所有人可见",
      OPEN_LINK: "打开链接",
      COPY_AND_CLOSE: "复制链接并关闭",
      ADD_COMPONENT: "添加组件",
      ...
      TEXT_COLOR: "文字颜色",
      DASHBOARD:"仪表盘",
      CONSOLE_SETTING: "看板设置",
      CONSOLE_ID: "看板编号",
      WHETHER_COMPONENT_CAN_BE_DRAGGED: "组件是否可拖拽",
      WHETHER_COMPONENT_CAN_BE_RESIZED: "组件是否可调整大小",
      WHETHER_DISPLAY_COMPONENT_TOOLBAR: "是否显示组件工具栏",
      WHETHER_COMPONENT_TITLE_CAN_BE_EDITED__DOUBLE_CLICK: "是否可编辑组件标题（双击标题编辑）",
      LOCK_TITLE_OR_NOT: "锁定/取消锁定标题",
    }
  },
  /**
   * 自动化
