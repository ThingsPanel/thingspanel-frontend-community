...
const rules: Record<keyof FormModel, FormItemRule | FormItemRule[]> = {
  ...
  gender: createRequiredFormRule("请检查数值"),
  ...
  remark: createRequiredFormRule("请检查数值")
}
