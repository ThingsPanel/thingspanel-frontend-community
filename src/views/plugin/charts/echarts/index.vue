...
const { domRef: lineRef } = useEcharts(() => lineOptions.value);
...
const { domRef: barRef } = useEcharts(() => barOptions.value);

const pictorialBarOption = ref<ECOption>(getPictorialBarOption()) as Ref<ECOption>;
const { domRef: pictorialBarRef } = useEcharts(() => pictorialBarOption.value);
...
const { domRef: scatterRef } = useEcharts(() => scatterOptions.value);
...
const { domRef: radarRef } = useEcharts(() => radarOptions.value);
...
const { domRef: gaugeRef } = useEcharts(() => gaugeOptions.value, {
  onDestroy: chart => {
