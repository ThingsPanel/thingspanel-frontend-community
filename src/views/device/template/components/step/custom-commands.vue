...
const customCommandTableThemeOverrides = {
...
const customCommandTableRowKey = (row: any) => row.id
...
<template>
  <div class="p-t-20px">
    ...
    <NDataTable
      ...
      class="custom-command-table flex-1-hidden"
      size="medium"
      :theme-overrides="customCommandTableThemeOverrides"
      :bordered="true"
      ...
      :striped="false"
      :scroll-x="900"
      :row-key="customCommandTableRowKey"
    >
      <template #empty>
