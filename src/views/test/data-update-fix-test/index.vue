<template>
  <div class="data-update-fix-test">
    <h1>🔧 数据更新修复测试</h1>
    <p class="description">测试原始数据修改后是否能立即更新，无需关闭重开配置面板</p>
    ...
    <div class="editor-config">
      ...
      <div class="test-buttons">
        <button class="btn btn-warning" @click="resetConfig">🔄 重置配置</button>
        <button class="btn btn-info" @click="simulateDataChange">🎲 模拟数据变更</button>
      </div>
    </div>
    ...
    <div class="real-time-logs">
      ...
      <div class="log-controls">
        ...
        <button class="btn" :class="autoScroll ? 'btn-success' : 'btn-outline'" @click="toggleAutoScroll">
