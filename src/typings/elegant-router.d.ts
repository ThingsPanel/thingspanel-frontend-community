...
declare module "@elegant-router/types" {
  ...
  export type RouteMap = {
    ...
    "test": "/test";
    "test_basic-test": "/test/basic-test";
    "test_card2-components-test": "/test/card2-components-test";
    "test_data-flow-test": "/test/data-flow-test";
    "test_data-source-config": "/test/data-source-config";
    "test_data-update-fix-test": "/test/data-update-fix-test";
    "test_datasource-integration": "/test/datasource-integration";
    "test_datasource-processor-test": "/test/datasource-processor-test";
    ...
    "test_simple-data-source": "/test/simple-data-source";
  ...
  export type LastLevelRouteKey = Extract<
    ...
    | "test_basic-test"
    | "test_card2-components-test"
    | "test_data-flow-test"
    | "test_data-source-config"
    | "test_data-update-fix-test"
    | "test_datasource-integration"
    | "test_datasource-processor-test"
    | "test_executor-integration"
    | "test_http-request-validation"
    | "test_interaction-system-test"
    | "test_json-data-input-test"
    | "test_minimal-test"
    | "test_original-config-test"
    | "test_property-exposure-test"
    | "test_simple-data-source"
    | "ultra-kanban_index"
