/**
 * Card 2.1 相对路径修复脚本
 * 将 src/card2.1 目录中所有相对路径统一转换为 @/ 绝对路径
 */
const fs = require('fs');
const path = require('path');

// card2.1 目录的路径
const CARD21_DIR = './src/card2.1';
 ...
 */
function main() {
  console.log('🚀 开始处理 Card 2.1 目录的相对路径转换...\n');
  
  // 获取所有文件
  const files = getAllFiles(CARD21_DIR);
